...
Java_com_driscord_jni_NativeDriscord_audioSend(JNIEnv* env, jclass, jbyteArray jdata, jint len) {
...
JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_audioSetDeafened(JNIEnv*, jclass, jboolean deaf) {
...
JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_audioSetMasterVolume(JNIEnv*, jclass, jfloat vol) {
...
JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_audioSetSelfMuted(JNIEnv*, jclass, jboolean muted) {
...
Java_com_driscord_jni_NativeDriscord_audioListInputDevices(JNIEnv* env, jclass) {
    const std::string json = CORE().audio_list_input_devices_json();
    return env->NewStringUTF(json.c_str());
}

JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_audioSetInputDevice(JNIEnv* env, jclass, jstring jId) {
...
JNIEXPORT jstring JNICALL
Java_com_driscord_jni_NativeDriscord_audioListOutputDevices(JNIEnv* env, jclass) {
    const std::string json = CORE().audio_list_output_devices_json();
    return env->NewStringUTF(json.c_str());
}

JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_audioSetOutputDevice(JNIEnv* env, jclass, jstring jId) {
    const char* id = env->GetStringUTFChars(jId, nullptr);
...
JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_audioOnPeerLeft(JNIEnv* env, jclass, jstring jPeer) {
    const char* peer = env->GetStringUTFChars(jPeer, nullptr);
...
Java_com_driscord_jni_NativeDriscord_audioGetPeerVolume(JNIEnv* env, jclass, jstring jPeer) {
    const char* peer = env->GetStringUTFChars(jPeer, nullptr);
...
Java_com_driscord_jni_NativeDriscord_audioGetPeerMuted(JNIEnv* env, jclass, jstring jPeer) {
    const char* peer = env->GetStringUTFChars(jPeer, nullptr);
