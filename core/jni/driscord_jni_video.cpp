...
Java_com_driscord_jni_NativeDriscord_videoSetWatching(JNIEnv*,
    jclass,
    jboolean watching)
{
...
JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_videoRemoveStreamingPeer(JNIEnv* env,
    jclass,
    jstring jPeer)
{
...
JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_setOnNewStreamingPeer(JNIEnv* env,
    jclass,
    jobject cb)
{
...
JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_setOnStreamingPeerRemoved(JNIEnv* env,
    jclass,
    jobject cb)
{
