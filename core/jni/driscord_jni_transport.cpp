...
Java_com_driscord_jni_NativeDriscord_addTurnServer(JNIEnv* env,
    jclass,
    jstring jUrl,
    jstring jUser,
    jstring jPass)
...
JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_setOnPeerJoined(JNIEnv* env,
    jclass,
    jobject cb)
{
...
JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_setOnPeerLeft(JNIEnv* env,
    jclass,
    jobject cb)
{
...
JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_setOnStreamingStarted(JNIEnv* env,
    jclass,
    jobject cb)
{
...
JNIEXPORT void JNICALL
Java_com_driscord_jni_NativeDriscord_setOnStreamingStopped(JNIEnv* env,
    jclass,
    jobject cb)
{
