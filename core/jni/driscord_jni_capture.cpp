...
JNIEXPORT jbyteArray JNICALL Java_com_driscord_jni_NativeDriscord_captureGrabThumbnail(
    JNIEnv* env,
    jclass,
    jstring jTargetJson,
    jint maxW,
    ...
    auto rgba =
        CORE().capture_grab_thumbnail(targetJson, static_cast<int>(maxW), static_cast<int>(maxH));
