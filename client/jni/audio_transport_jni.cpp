...
#define AT() DriscordState::get().core.audio_transport
...
JNIEXPORT jfloat JNICALL Java_com_driscord_jni_NativeAudioTransport_masterVolume(JNIEnv*, jclass) {
...
JNIEXPORT jfloat JNICALL Java_com_driscord_jni_NativeAudioTransport_outputLevel(JNIEnv*, jclass) {
    return AT().output_level();
}

JNIEXPORT jboolean JNICALL Java_com_driscord_jni_NativeAudioTransport_selfMuted(JNIEnv*, jclass) {
...
JNIEXPORT jfloat JNICALL Java_com_driscord_jni_NativeAudioTransport_inputLevel(JNIEnv*, jclass) {
...
JNIEXPORT void JNICALL Java_com_driscord_jni_NativeAudioTransport_setScreenAudioReceiver(
    ...
    if (screenHandle != 0) {
        recv = DriscordState::get().core.screen_session->audio_receiver(peer);
    }
